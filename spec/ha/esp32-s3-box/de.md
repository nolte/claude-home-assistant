...
- Der **microSD**-Slot **MUSS [MUST]** ungenutzt bleiben; lokaler Audiobedarf **MUSS [MUST]** stattdessen aus dem Flash gedeckt werden — die `media_player`-Speaker-Plattform bettet Sounddateien direkt ein, so wie die Referenzkonfiguration es für ihren Timer-Klang tut `[ref-config]` `[policy]`
