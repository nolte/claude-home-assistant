...
- **Maintainer, die einen PR oder ein Release vorbereiten.** Du willst ein gebündeltes Review, das Quality-Scale-, Sicherheits- und übergreifende Probleme gemeinsam aufspürt, damit Du sie behebst, bevor Reviewer oder Nutzer es tun. Der Agent `ha-integration-reviewer` liefert Dir diesen Gesamtdurchlauf.
