...
dont_use_when:
  ...
  - situation: "You want to verify a running integration on a live pod"
    alternative: ha-integration-verifier
...
- diagnose or verify a live pod — that is `ha-integration-deployer` / `ha-integration-verifier`
